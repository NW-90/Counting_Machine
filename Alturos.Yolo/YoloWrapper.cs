    ...
    public class YoloWrapper : IDisposable
    {
        ...
        private void Initialize(string configurationFilename, string weightsFilename, string namesFilename, int gpu = 0, bool ignoreGpu = false)
        {
            ...
            switch (this.DetectionSystem)
            {
                ...
                case DetectionSystem.GPU:
                    ...
                    #endregion GetDeviceName แก้ Bug
        ...
        private bool IsMicrosoftVisualCPlusPlus2017Available()
        {
            ...
            var checkKeys = new string[]
            {
                ...
                @"Installer\Dependencies\VC,redist.x64,amd64,14.22,bundle", //Microsoft Visual C++ 2015-2019 Redistributable (x64) - 14.22.27821
                ...
                @"Installer\Dependencies\VC,redist.x64,amd64,14.23,bundle", //Visual C++ 2019 (2015-2019 bundle) (x64) 
                @"Installer\Dependencies\VC,redist.x64,amd64,14.24,bundle", //Visual C++ 2019 (2015-2019 bundle) (x64)
                @"Installer\Dependencies\VC,redist.x64,amd64,14.25,bundle", //Visual C++ 2019 Preview
                @"Installer\Dependencies\VC,redist.x64,amd64,14.26,bundle", //Visual C++ 2019 Preview 13/04/2020
                @"Installer\Dependencies\VC,redist.x64,amd64,14.27,bundle", //Visual C++ 2019 Preview 28/10/2020
            };
